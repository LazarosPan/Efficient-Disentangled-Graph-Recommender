...
description: Summarizes key causal inference techniques and their implementation mechanics for the repository.
---

This skill is pointer to causal inference resources:

- [identification_logic.md](identification_logic.md): identification logic in practice involves using Structural Causal Models (SCMs), graphical representations like DAGs, the rules of do-calculus, and various identification strategies.
- [discovery_algorithms.md](discovery_algorithms.md): infer causal graphs from data, focusing on interpreting results and understanding the practical implications of different algorithm choices.
