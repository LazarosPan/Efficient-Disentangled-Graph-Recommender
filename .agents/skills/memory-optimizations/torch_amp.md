Automatic Mixed Precision package - torch.amp (https://docs.pytorch.org/docs/2.11/amp.html)
...
[source]
    ...
    Parameters:
        ...
        device_type (str) – Device type to use. Possible values are: ‘cuda’, ‘cpu’, ‘mtia’, ‘maia’, ‘xpu’, and so on. The type is the same as the type attribute of a torch.device. Thus, you may obtain the device type of a tensor using Tensor.device.type.
    Return type:
...
[source]
    ...
    Parameters:
            ...
            device_type (str, required) – Device type to use. Possible values are: ‘cuda’, ‘cpu’, ‘mtia’, ‘maia’, ‘xpu’, and ‘hpu’. The type is the same as the type attribute of a torch.device. Thus, you may obtain the device type of a tensor using Tensor.device.type.
...
[source]
    ...
    Parameters:
            ...
            device_type (str) – Device type to use. ‘cuda’, ‘cpu’, ‘mtia’, ‘maia’, ‘xpu’ and so on. The type is the same as the type attribute of a torch.device. Thus, you may obtain the device type of a tensor using Tensor.device.type.
