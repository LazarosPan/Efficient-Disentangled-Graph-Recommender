...
| `amazonbook-edgrec-candidate-search` | `amazonbook-edgrec-compact-candidate` | AmazonBook only | `ValidationOnlineCRRU@20_40` | TPE seed 42, startup 4; Hyperband min 6, factor 3, bootstrap 1 | `max_epochs=60`, `trials=12`, compares `compact` and `deep_features` profile-family labels under one objective/revision; current evidence does not prove best AmazonBook hyperparameters |
