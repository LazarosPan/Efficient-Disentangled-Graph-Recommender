---
name: numba
description: Numba documentation files. Use when developing performance-sensitive code that can benefit from JIT compilation, such as numerical algorithms, data processing, or custom CUDA kernels.
---

## Numba Reference Files
