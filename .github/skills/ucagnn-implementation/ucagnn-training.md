...
- `num_neighbors` controls `SubgraphSampler` per-hop fan-out and is the primary tool for managing subgraph density and VRAM. The current default is `[10, 5, 5]`.
