...
| --- | --- | --- | --- |
| `L_rec` | `final_score(pos)` vs `final_score(neg)` | `loss_weight_recommendation = 1.0` | Always on; IPW-reweighted with self-normalized detached weights when `use_ipw=True` |
