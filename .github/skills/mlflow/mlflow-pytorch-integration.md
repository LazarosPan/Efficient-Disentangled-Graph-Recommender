...
## System Metrics Tracking[​](#system-metrics-tracking "Direct link to System Metrics Tracking")
...
## Checkpoint Tracking[​](#checkpoint-tracking "Direct link to Checkpoint Tracking")
...
with mlflow.start_run():
    ...
    # Tag for tracking
    mlflow.set_tags({"model_type": "cnn", "dataset": "imagenet", "framework": "pytorch"})
